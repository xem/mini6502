...
r=(d,b)=>(c++,m[d%65536])
w=(d,b)=>(c++,m[d%65536]=b)
F=(d,b)=>(Z=(d&=255)<1,N=(d&=255)>>7,d)
f=(d,b)=>(C=d&1,Z=d>>1&1,I=d>>2&1,D=d>>3&1,B=d>>4&1,V=d>>6&1,N=d>>7)
f(P=36)
push=(d,b)=>(w(256+S--,d),S&=255)
pop=(d,b)=>r(256+(S=255&S+1))
...
t=p+256*r(PC+2),c+=t>>8<t+X>>8||o>>4==9||(15&o)>13,a=t+X,PC+=2`.split`
...
Z||(c+=1+(a>>8!=PC+1>>8),PC=a)
V=0`.split`
`[`UE#UE#GEBUE#=E#UE#1E#UE#C6%)6%I6$)6%<6%D6%D6%C6%J@'J@'F@&:@'>@'J@'4@'J@'T90T90H9*:90W90T90290T90QMNQMN-NSQMNVMNQMNRMKQMN/5?/5?L5P/5?;5?/5?Z5O/5?"7A"7A.7("7AY7A"7A37A"7A!8+!8+,8[!8+X8+!8+ 8+!8+`[b-(b>>2)].charCodeAt()-32]))
op=(d,b)=>(o=r(PC),p=r(a=PC+1),d?(2==d?S=S-3&255:(push(PC>>8),push(255&PC),push(b||239&P)),I=1,PC=r(65528+2*A)+256*r(65528+2*d+1)):(O[o](),PC++),P=C+2*Z+4*I+8*D+16*B+32+64*V+128*N)