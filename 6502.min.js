...
o>76&&(a=r(a)+256*r(a+1-256*(a&255>254))),PC=a-1
...
op=(d,b)=>(o=r(PC),p=r(a=PC+1),d?(2-d?(h(PC>>8),h(255&PC),h(b||239&P)):S=S-3&255,I=1,PC=r(65528+2*A)+256*r(65528+2*d+1)):(O[o](),PC++),P=C+2*Z+4*I+8*D+16*B+32+64*V+128*N)